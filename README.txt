...
there will be display on the file: ***ERROR 1 <actual unknown token> in line 1*** 
and in the console will be display the error number with the 
line where it is the error.

This program scann C# code, and verify if the tokens are valid 
in a C# context. Must be consider that this does not verify
syntax of C#.
